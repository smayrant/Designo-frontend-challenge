...
;// CONCATENATED MODULE: ./src/img/map-canada.png
const map_canada_namespaceObject = __webpack_require__.p + "img/map-canada.png";
;// CONCATENATED MODULE: ./src/img/map-australia.png
const map_australia_namespaceObject = __webpack_require__.p + "img/map-australia.png";
;// CONCATENATED MODULE: ./src/img/map-uk.png
const map_uk_namespaceObject = __webpack_require__.p + "img/map-uk.png";
;// CONCATENATED MODULE: ./src/img/map-canada-desktop.png
const map_canada_desktop_namespaceObject = __webpack_require__.p + "img/map-canada-desktop.png";
;// CONCATENATED MODULE: ./src/img/map-australia-desktop.png
const map_australia_desktop_namespaceObject = __webpack_require__.p + "img/map-australia-desktop.png";
;// CONCATENATED MODULE: ./src/img/map-uk-desktop.png
const map_uk_desktop_namespaceObject = __webpack_require__.p + "img/map-uk-desktop.png";
;// CONCATENATED MODULE: ./src/img/bg-pattern-three-circles.svg
const bg_pattern_three_circles_namespaceObject = __webpack_require__.p + "img/bg-pattern-three-circles.svg";
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [449], () => (__webpack_require__(2729)))
