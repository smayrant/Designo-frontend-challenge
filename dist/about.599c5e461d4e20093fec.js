...
;// CONCATENATED MODULE: ./src/img/about-hero.jpg
const about_hero_namespaceObject = __webpack_require__.p + "img/about-hero.jpg";
;// CONCATENATED MODULE: ./src/img/world-class-talent.jpg
const world_class_talent_namespaceObject = __webpack_require__.p + "img/world-class-talent.jpg";
...
;// CONCATENATED MODULE: ./src/img/real-deal.jpg
const real_deal_namespaceObject = __webpack_require__.p + "img/real-deal.jpg";
...
aboutBg.style.backgroundImage = "url(\"".concat(bg_pattern_intro_web_namespaceObject, "\")");
var aboutHero = document.querySelector(".about__hero-img");
aboutHero.src = about_hero_namespaceObject;
var talentImg = document.querySelector(".talent-img");
talentImg.src = world_class_talent_namespaceObject;
...
talentBg.style.backgroundImage = "url(\"".concat(bg_pattern_three_circles_namespaceObject, "\")");
var realDealBg = document.querySelector(".about__text-container--real-deal");
realDealBg.style.backgroundImage = "url(\"".concat(bg_pattern_three_circles_namespaceObject, "\")");
var realDealImg = document.querySelector(".real-deal-img");
realDealImg.src = real_deal_namespaceObject; // Contact
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [449], () => (__webpack_require__(9792)))
